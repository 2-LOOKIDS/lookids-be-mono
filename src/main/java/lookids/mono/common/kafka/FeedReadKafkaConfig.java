...
public class FeedReadKafkaConfig {
	...
	//
	// @Bean
	// public ConsumerFactory<String, FeedReadKafkaDto> feedConsumerFactory() {
	// 	return createConsumerFactory(FeedReadKafkaDto.class, "feed-read-group");
	// }
	//
	// @Bean
	// public ConcurrentKafkaListenerContainerFactory<String, FeedReadKafkaDto> feedEventListenerContainerFactory() {
