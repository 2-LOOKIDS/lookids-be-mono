...
public class SubscribeKafkaListener {
	...
	public NotificationRequestDto consumeFeedEvent(FeedKafkaRequestDto kafkaFeedRequestDto) {
		...
		return NotificationRequestDto.toDto(kafkaFeedRequestDto, receiverUuidList, splitedContent, TYPE);
